      ...
      <div className='flex justify-center mt-12'>
        ...
        {pages.map(btnNum => (
          <button 
            ...
            key={btnNum}
            className={`hidden px-4 py-2 mx-1 transition-colors ${currentPage===btnNum?'bg-blue-500 text-white':''} duration-300 transform  rounded-md sm:inline hover:bg-blue-500  hover:text-white`}
          >
            {btnNum}
          </button>
        ))}
