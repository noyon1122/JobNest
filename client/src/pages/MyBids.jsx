...
const handleStatus=async(id)=>{
  ...
  const {data}=await axios.patch(`${import.meta.env.VITE_API_URL}/bid/${id}`,{status:"Completed"})
  console.log(data)
